...
const feeReceiptRoute = require("./routes/feeReceiptRoutes");
const paySlipRoutes = require("./routes/paySlipRoutes");
const resultRoute = require("./routes/resultRoutes");
const bulkRoutes = require("./routes/bulkRoutes");
const academicEventsRoutes = require("./routes/academicEventsRoutes");
const noticeBoxRoutes = require("./routes/noticeBoxRoutes");
...
app.use("/fee-receipt", feeReceiptRoute);
app.use("/pay-slip", paySlipRoutes);
app.use("/result", resultRoute);
app.use("/bulk", bulkRoutes);
app.use("/academicevents", academicEventsRoutes);
app.use("/noticebox", noticeBoxRoutes);
...
app.get("/", (req, res) =>
  res.send(
    '<h1 style="display:flex;height: 100%;align-items: center;justify-content: center;margin:0;">Server Is Running!!!!</h1>'
  )
);
